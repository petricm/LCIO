...
namespace EVENT {
  ...
  public: 
    ~Exception() throw() override { /*no_op*/; } 
  ...
  public: 
    ~EventException() throw() override { /*no_op*/; } 
  ...
  public: 
    ~DataNotAvailableException() throw() override { /*no_op*/; } 
  ...
  public: 
    ~ReadOnlyException() throw() override { /*no_op*/; } 
...
namespace IO {
  ...
  public: 
    ~EndOfDataException() throw() override { /*no_op*/; } 
