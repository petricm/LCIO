...
PTRTYPE lcrcpcreate(){
  auto* rcp = new ReconstructedParticleImpl ;
  return C2F_POINTER( LCObject*, rcp ) ;
}
int lcrcpdelete( PTRTYPE recopart ){
  auto* rcp = f2c_pointer<ReconstructedParticleImpl,LCObject>( recopart ) ;
  delete rcp ;
  return LCIO::SUCCESS ;
}
...
PTRTYPE lcrcpgetstartvertex( PTRTYPE recopart ) {
  auto* rcp = f2c_pointer<ReconstructedParticle,LCObject>( recopart ) ;
...
int lcrcpaddparticleid( PTRTYPE recopart, PTRTYPE pid ) {
  auto* rcp = f2c_pointer<ReconstructedParticleImpl,LCObject>( recopart ) ;
  auto* ppid = f2c_pointer<ParticleID,LCObject>( pid ) ;
...
int lcrcpaddparticle( PTRTYPE recopart, PTRTYPE particle ) {
  auto* rcp = f2c_pointer<ReconstructedParticleImpl,LCObject>( recopart ) ;
  auto* rparticle = f2c_pointer<ReconstructedParticle,LCObject>( particle ) ;
...
int lcrcpaddtrack( PTRTYPE recopart, PTRTYPE track ) {
  auto* rcp = f2c_pointer<ReconstructedParticleImpl,LCObject>( recopart ) ;
  auto* ctrack = f2c_pointer<Track,LCObject>( track ) ;
  rcp->addTrack( ctrack ) ;
  return LCIO::SUCCESS ;
}
...
int lcrcpsetstartvertex( PTRTYPE recopart, PTRTYPE vertex ) {
  auto* rcp = f2c_pointer<ReconstructedParticleImpl,LCObject>( recopart ) ;
  auto* vtx = f2c_pointer<Vertex,LCObject>( vertex ) ;
